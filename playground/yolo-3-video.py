...
video = cv2.VideoCapture('playground/media/test-street-03.mp4')
...
Reading input video
"""
img_org = cv2.imread("playground/media/test-street-03-marked.png")
...
while True:
    ...
    if iteration % 2 == 0:
        ...
        warped, M = tools.four_point_transform(frame, corners)
        top_view, M = tools.warpPerspectivePadded(frame, warped, M)
        ...
        if writer is None:
            ...
            writer = cv2.VideoWriter('playground/media/result.mp4', fourcc, 30,
